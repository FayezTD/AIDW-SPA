...
export const msalConfig = {
  auth: {
    ...
    redirectUri: process.env.REACT_APP_REDIRECT_URI || 'https://mango-hill-0032f541e.6.azurestaticapps.net/',
    postLogoutRedirectUri: process.env.REACT_APP_REDIRECT_URI || 'https://mango-hill-0032f541e.6.azurestaticapps.net/',
